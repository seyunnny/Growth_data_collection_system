...
public class SignupActivity extends AppCompatActivity {
    ImageButton backBtn, checkBtn, cancelBtn;
...
//        });
//
//        // 확인 버튼 클릭할 경우 데이터 저장 후 로그인으로 넘어가게 하기....
//        checkBtn = findViewById(R.id.checkBtn);
//        checkBtn.setOnClickListener(v -> {
//            SignupSql = "INSERT INTO member(userID, userPW, userName, userPhone) values (editTextID, editTextPW, editTextName, editTextPhone);";
//            sqlDB = dbHelper.getWritableDatabase();
//            sqlDB.execSQL(SignupSql);
//            sqlDB.close();
